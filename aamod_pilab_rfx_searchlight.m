% group analysis of searchlight pilab results.
%
% [aap,resp]=aamod_pilab_rfx_searchlight(aap,task)
function [aap,resp]=aamod_pilab_rfx_searchlight(aap,task)
...
switch task
    case 'doit'
        ...
        aap = aas_desc_outputs(aap,'pilab_result_rfx',rpaths);
